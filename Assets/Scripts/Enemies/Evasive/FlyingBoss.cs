...
public class FlyingBoss : SimpleEnemy
{
    // Override Awake to disable gravity, store the flying altitude,
    // and ignore collisions with the Ground layer.
    protected override void Awake()
    {
        ...
        // Ignore collisions between this boss and the Ground layer.
        int groundLayerNum = LayerMask.NameToLayer("Ground");
        // This call ignores collisions between the boss's layer and the ground layer.
